...
// ── 1. 页面总数 = 84（78 + 二维码/JSON/Base64/URL/拼音/归属地 六新工具） ──
{
  const n = htmlFiles.length;
  if (n === 84) pass(`1. 页面总数 = 84（实际 ${n}）`);
  else fail("1. 页面总数应为 84", `实际 ${n}`);
}
...

{
  ...
  if (issues.length) {
    ...
    pass(
      `11. a11y（84 页 h1=1、main/skip-link/label/alt/btn/anc 全齐，对比度 9 组 ≥4.5:1）`,
    );
  }
}
