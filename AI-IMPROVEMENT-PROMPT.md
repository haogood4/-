...
- [x] P1-4 GitHub Actions：push/PR 跑 `pnpm verify && pnpm build`，产物页数断言 =70｜预估 3h｜✅ 2026-09-20 完成：`.github/workflows/ci.yml`（Node 22 + pnpm 11 + frozen-lockfile，页数断言修正为 71，附 sitemap/robots/manifest 存在性检查）；沙箱无 git，工作流待推送 GitHub 后首跑验证
